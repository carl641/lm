...
| File | Purpose |
|---|---|
| `index.html` | Home: hero, credibility strip, practice areas, attorneys, first-meeting guide, call band |
...
1. **Photography.** The site ships with styled placeholders; drop real photos into
   ...
   - `index.html` hero panel: office exterior or the Limestone County Courthouse (portrait, ~1200×1400)
